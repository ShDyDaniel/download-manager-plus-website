...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'ניהול תשלומים, כל ההכנסות מסודרות במקום אחד - ככה לא מפספסים כלום',
  ...
  },
  {
    ...
    items: [
      ...
      'עיבוד הקבצים (הורדה, מיון, המרה) מתבצע מקומית במחשב שלך',
      'נתוני התשלומים מוצפנים ונעולים במחשב שלך בלבד',
    ],
  },
]
