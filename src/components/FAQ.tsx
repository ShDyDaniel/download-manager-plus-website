...
const QA: { q: string; a: string }[] = [
  ...
  {
    q: 'התוכנה חינם?',
    a: 'יש מסלול חינמי קבוע, ומעליו שלושה מסלולים בתשלום: Basic, Pro ו-Ultra. המחירים כוללים מע״מ, והפירוט המלא של מה כלול בכל מסלול נמצא בדף הרכישה. אחרי ההתקנה אפשר לקבל 7 ימי ניסיון מלאים, בלי כרטיס אשראי.',
  },
  {
  ...
  },
  {
    ...
    a: 'המערכת לא נוגעת בתיקייה ריקה שיצרתם בתיקיית ההורדות.',
  },
  {
  ...
  },
  {
    ...
    a: 'כן, לפי המסלול: חינם ו-Basic מחשב אחד, Pro שני מחשבים ו-Ultra שלושה. הרשימה נמצאת באיזור האישי באתר, ושם גם משחררים מחשב כדי לפנות מקום לאחר — בלי לפנות לתמיכה.',
  },
  {
