...
const QA: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'הגדרות הניתוב, רשימת הפרויקטים שלך והקבצים שמועברים אצלך בלבד. רק פרטי החשבון (מייל, שם, סטטוס מנוי) מאוחסנים ב-Firebase לצורך אימות.',
  },
  {
  ...
  },
  {
    ...
    a: 'התוכנה בודקת אוטומטית בכל הפעלה אם יצא עדכון. כשיש עדכון, מופיע כפתור "עדכן עכשיו" — בלחיצה אחת ההורדה מתחילה והמתקין נפתח.',
  },
  {
