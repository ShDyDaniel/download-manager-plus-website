...
const STEPS = [
  ...
  {
    title: 'בחר אותו כפעיל',
    body: 'כל הקבצים שיגיעו לתיקיית ההורדות מעכשיו ינוטבו אליו אוטומטית.',
  },
  {
    title: 'בדוק את החוקים',
    body: 'בכרטיסיית ההגדרות תראה איזה קובץ הולך לאיזו תיקייה. ערוך אם צריך, הוסף חוקים משלך.',
  },
  {
    title: 'תוריד משהו',
    body: 'תוריד קובץ כרגיל (דפדפן, יוטיוב, כל מקור) — תראה אותו עובר לתיקייה המתאימה אוטומטית בתוך שניות.',
  },
]
